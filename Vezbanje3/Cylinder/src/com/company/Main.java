...
//        1. Write a class with the name Circle. The class needs one field
//        (instance variable) with name radius of type double.
//     The class needs to have one constructor with parameter radius
...
//* Method named getArea without any parameters, it needs to return
// the calculated area (radius * radius * PI). For PI use Math.PI constant.

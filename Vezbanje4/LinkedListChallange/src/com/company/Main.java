...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album1.addSong("I put the finger on you", 3.24);
        album1.addSong("Let's go", 4.14);
        album1.addSong("Inject the venom", 2.54);
        album1.addSong("Snowballed", 6.24);
        album1.addSong("Evil walks", 3.12);
        album1.addSong("C.O.D.", 4.01);
        album1.addSong("Breaking the rules", 3.33);
    ...
    private static void printMenu() {
        ...
        System.out.println(" 5 - list the menu");
    }
